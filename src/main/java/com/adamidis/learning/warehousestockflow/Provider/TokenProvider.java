package com.adamidis.learning.warehousestockflow.Provider;
...
public class TokenProvider {
    ...
    public String createAccessToken(UserPrincipal userPrincipal) {
        return JWT.create().withIssuer(JAVA_LEARNING_SA).withAudience(WAREHOUSE_MANAGEMENT_SYSTEM)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(JAVA_LEARNING_SA).build();
