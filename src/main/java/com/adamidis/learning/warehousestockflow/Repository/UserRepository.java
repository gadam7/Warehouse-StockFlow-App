...
public interface UserRepository <T extends User> {
    ...
    T create(T data); // Create a new user

    Collection<T> list(int page, int pageSize); // List users with pagination

    T get(Long id); // Get a user by ID

    T update(T data); // Update an existing user

    Boolean delete(Long id); // Delete a user by ID
