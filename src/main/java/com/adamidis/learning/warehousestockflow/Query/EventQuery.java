...
public class EventQuery {
    ...
    public static final String INSERT_EVENT_BY_USER_EMAIL_QUERY = "INSERT INTO UserEvents (user_id, event_id, device, ip_address) SELECT u.id, e.id, :device, :ipAddress FROM Users u, Events e WHERE u.email = :email AND e.type = :type";
}
